...
const Navbar = () => {
  return (
    <div className="w-full fixed  z-[10000] top-0 h-[8vh] flex items-center justify-between  bg-[#043873] shadow-md">
      <div className="w-[90%] mx-[15rem] grid-cols-1 grid lg:grid-cols-2 gap-[3rem] h-full items-center">
        <Image src="/images/logo.png" alt="logo image" width={191} height={34}  />
        
        
        <div className="flex space-x-9 justify-end items-center text-white font-bold gap-x-14 
        font-dm-sans  text-[18px] leading-[23px] ">
          ...
          <div className='bg-[#4F9CF9] rounded-[8px]  h-[60px] flex justify-center items-center relative right-8' >
